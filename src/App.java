public class App {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(DataHelper.getRandomInteger(2));
        System.out.println(DataHelper.getRandomInteger(2, 2));
        System.out.println(DataHelper.getRandomInteger(5, 3, 6));
